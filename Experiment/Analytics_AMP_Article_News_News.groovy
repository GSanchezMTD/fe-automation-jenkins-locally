    ...
    configFileProvider(
        [
            configFile(
                ...
                replaceTokens: true,
                targetLocation: '/var/lib/jenkins/workspace/QA-Selenium/Jenkins/configfiles/configfiles/FE Core STG Configuration',
                variable: 'configData'
            )
        ]
    ) {
        load "/var/lib/jenkins/workspace/QA-Selenium/Jenkins/configfiles/configfiles/FE Core STG Configuration"
